...
# 50+ MEGA PINGS NORMAIS (PRÉ FORÇA MÁXIMA)
@tasks.loop(seconds=0.001)
async def mega_ping_normal_1():
    try:
        async with aiohttp.ClientSession() as session:
